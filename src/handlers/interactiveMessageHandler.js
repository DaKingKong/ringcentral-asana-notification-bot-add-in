        ...
        switch (body.data.actionType) {
            ...
            case 'submitConfig':
                ...
                if (newWorkspaceId == subscription.workspaceId) {
                    ...
                    const newSubscription = await subscriptionHandler.subscribe(asanaUser, newWorkspace, groupId, newTaskDueReminder, newTimezoneOffset);
