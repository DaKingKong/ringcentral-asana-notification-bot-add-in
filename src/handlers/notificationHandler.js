        ...
        for (const event of incomingEvents) {
            ...
            if (event.resource.resource_type == 'task') {
                ...
                // case.2: My Task due change
                    ...
                    const taskDueDateChangeCard = cardBuilder.taskDueDateChangeCard(taskName, taskDescription, projectNames, taskPriority, taskDueDate, username, userEmail, taskLink);
